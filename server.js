...
app.get("/widget/chatbot-widget.js", async (req, res) => {
  ...
  try {
    ...
    const selectedLanguage = website.preferences.language || "en"; // This can be dynamically set based on user's browser language or a setting.
    ...
    const widgetScriptPart1 = `(function () {
            ...
            const t = ${JSON.stringify(translatedPhrases)}

            console.log(t["We're here to help!"])
                    ...
                    socket.on("chat_update", (data) => {
                        ...
                        if (data.chatId === currentChatId) { 
                            ...
                            if (data.status === 'closed') {
                                ...
                                renderMessage('bot', data.message || t['This conversation has been closed.'], new Date().toISOString());
                            }
                        } else {
